...
|---------|----------------|--------|
| Python | The language itself — from basics to production patterns | `01_Python_Mastery/` |
| DSA | Data structures + algorithms — how to think and solve problems | `02_DSA_Mastery/` |
| API | How services communicate — REST, FastAPI, auth, deployment | `03_API_Mastery/` |
| System Design | How to design large systems — databases, caching, scale | `04_System_Design_Mastery/` |
...
| # | Topic | File |
|---|-------|------|
| 1 | Fundamentals | `01_Python_Mastery/01_python_fundamentals/theory.md` |
| 2 | Control Flow | `01_Python_Mastery/02_control_flow/theory.md` |
| 3 | Data Types | `01_Python_Mastery/03_data_types/theory.md` |
| 4 | Functions | `01_Python_Mastery/04_functions/theory.md` |
| 5 | OOP | `01_Python_Mastery/05_oops/theory.md` |
| 6 | Exceptions | `01_Python_Mastery/06_exceptions_error_handling/theory.md` |
...
| # | Topic | File |
|---|-------|------|
| 1 | Complexity Analysis | `02_DSA_Mastery/01_complexity_analysis/theory.md` |
| 2 | Arrays | `02_DSA_Mastery/02_arrays/theory.md` |
| 3 | Strings | `02_DSA_Mastery/03_strings/theory.md` |
| 4 | Recursion | `02_DSA_Mastery/04_recursion/theory.md` |
| 5 | Sorting | `02_DSA_Mastery/05_sorting/theory.md` |
| 6 | Searching | `02_DSA_Mastery/06_searching/theory.md` |

For each topic, read in this order:
```
theory.md → visual_explanation.md → cheetsheet.md → common_mistakes.md → real_world_usage.md → interview.md
```
...
| # | Topic | File |
|---|-------|------|
| 7 | Linked List | `02_DSA_Mastery/07_linked_list/theory.md` |
| 8 | Stack | `02_DSA_Mastery/08_stack/theory.md` |
| 9 | Queue | `02_DSA_Mastery/09_queue/theory.md` |
| 10 | Hashing | `02_DSA_Mastery/10_hashing/theory.md` |
| 11 | Two Pointers | `02_DSA_Mastery/11_two_pointers/theory.md` |
| 12 | Sliding Window | `02_DSA_Mastery/12_sliding_window/theory.md` |
| 13 | Binary Search | `02_DSA_Mastery/13_binary_search/theory.md` |
...
| # | Topic | File |
|---|-------|------|
| 7 | Modules & Packages | `01_Python_Mastery/07_modules_packages/theory.md` |
| 8 | File Handling | `01_Python_Mastery/08_file_handling/theory.md` |
| 9 | Logging & Debugging | `01_Python_Mastery/09_logging_debugging/theory.md` |
| 10 | Decorators | `01_Python_Mastery/10_decorators/theory.md` |
| 11 | Generators | `01_Python_Mastery/11_generators_iterators/theory.md` |
| 12 | Context Managers | `01_Python_Mastery/12_context_managers/theory.md` |
| 13 | Concurrency | `01_Python_Mastery/13_concurrency/theory.md` |
| 14 | Memory Management | `01_Python_Mastery/14_memory_management/theory.md` |
...
|   | FastAPI + DB | `03_API_Mastery/07_fastapi/database_guide.md` |
|   | FastAPI Advanced | `03_API_Mastery/07_fastapi/advanced_guide.md` |
...
| # | Topic | File |
|---|-------|------|
| 14 | Trees | `02_DSA_Mastery/14_trees/theory.md` |
| 15 | BST | `02_DSA_Mastery/15_binary_search_trees/theory.md` |
| 16 | Heaps | `02_DSA_Mastery/16_heaps/theory.md` |
| 17 | Trie | `02_DSA_Mastery/17_trie/theory.md` |
| 18 | Graphs | `02_DSA_Mastery/18_graphs/theory.md` |
| 19 | Greedy | `02_DSA_Mastery/19_greedy/theory.md` |
| 20 | Backtracking | `02_DSA_Mastery/20_backtracking/theory.md` |
| 21 | Dynamic Programming | `02_DSA_Mastery/21_dynamic_programming/theory.md` |
...
| 3 | Caching | `04_System_Design_Mastery/06_caching/theory.md` |
| 4 | Load Balancing | `04_System_Design_Mastery/08_load_balancing/theory.md` |
| 4 | Message Queues | `04_System_Design_Mastery/09_message_queues/theory.md` |
...
| # | Topic | File |
|---|-------|------|
| 16 | Design Patterns | `01_Python_Mastery/16_design_patterns/theory.md` |
...
| Stage | Topic | File |
|-------|-------|------|
| 5 | Scalability Patterns | `04_System_Design_Mastery/11_scalability_patterns/theory.md` |
| 5 | Microservices | `04_System_Design_Mastery/12_microservices/theory.md` |
| 5 | Security | `04_System_Design_Mastery/13_security/theory.md` |
| 5 | Observability | `04_System_Design_Mastery/14_observability/theory.md` |
| 6 | High Level Design | `04_System_Design_Mastery/16_high_level_design/theory.md` |
| 6 | Low Level Design | `04_System_Design_Mastery/17_low_level_design/theory.md` |
| 6 | Design Patterns | `04_System_Design_Mastery/18_design_patterns/theory.md` |
| 6 | Clean Architecture | `04_System_Design_Mastery/19_clean_architecture/theory.md` |
| 8 | Case Studies | `04_System_Design_Mastery/22_case_studies/theory.md` |
| 8 | Interview Framework | `04_System_Design_Mastery/23_interview_framework/theory.md` |
...
| # | Topic | File |
|---|-------|------|
| 22 | Bit Manipulation | `02_DSA_Mastery/22_bit_manipulation/theory.md` |
| 23 | Segment Tree | `02_DSA_Mastery/23_segment_tree/theory.md` |
| 24 | Disjoint Set Union | `02_DSA_Mastery/24_disjoint_set_union/theory.md` |
| 25 | Advanced Graphs | `02_DSA_Mastery/25_advanced_graphs/theory.md` |
| 26 | System Design Patterns | `02_DSA_Mastery/26_system_design_patterns/theory.md` |
|   | DSA Interview Master | `02_DSA_Mastery/99_interview_master/` |
|   | System Design Interview | `04_System_Design_Mastery/99_interview_master/` |
...
6. cheetsheet.md      → Use as a quick reference during practice
...
Every system-design folder has `theory.md` + `interview.md` + `cheetsheet.md`.
...
5. Use cheetsheet.md as a 10-minute pre-interview review
```
...
| Daily Job Guide | [04_DAILY_JOB_GUIDE.md](./04_DAILY_JOB_GUIDE.md) |
