...
**Prev:** [← Cheat Sheet](./cheetsheet.md) &nbsp;|&nbsp; **Next:** [Api Design — Overview →](../03_api_design/overview.md)

**Related Topics:** [Fundamentals](./fundamentals.md) · [Theory](./theory.md) · [Cheat Sheet](./cheetsheet.md)
