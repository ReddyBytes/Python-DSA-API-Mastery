...
| `devmastery` | AI Engineer career roadmap | Read at start — also available locally as `05_AI_ENGINEER_ROADMAP.md` |
...
```
05_AI_ENGINEER_ROADMAP.md                            ← understand the destination (local copy)
01_QUICK_START.md                                     ← understand the Python repo structure
04_DAILY_JOB_GUIDE.md                                ← understand what skills matter at work
...
**Duration:** 3 weeks
**Repo:** `Python-DSA-API-Mastery/01_Python_Mastery/`
...
```
05_Capstone_Projects/03_Data_Pipeline_CLI/     ← uses everything from Phase 1
```
...
```
01_Python_Mastery/22_numpy_for_ai/
01_Python_Mastery/23_pandas_for_ai/
01_Python_Mastery/26_statistics_and_probability/
01_Python_Mastery/27_matplotlib_seaborn/
01_Python_Mastery/28_eda_workflow/
```
...
```
01_Python_Mastery/30_sql_with_python/     ← SQLAlchemy ORM + psycopg2
```
...
**Also cover from Python repo:**
```
01_Python_Mastery/25_python_ai_ecosystem/    ← ML library overview
01_Python_Mastery/29_web_scraping/           ← data collection
```
...
**Duration:** 3 weeks
**Repo:** `Python-DSA-API-Mastery/03_API_Mastery/`
...
### Phase 5 Capstone
```
05_Capstone_Projects/14_Ecommerce_API_FastAPI/     ← full production FastAPI project
```

### Phase 5 Interview Prep
```
03_API_Mastery/99_interview_master/api_questions.md
03_API_Mastery/99_interview_master/scenario_based_questions.md    ← 12 production scenarios
```
...
**Duration:** 4 weeks
**Repos:** `AI-ENGINEERS-ATLAS/` + `Python-DSA-API-Mastery/04_System_Design_Mastery/`
...
| Module | Folder | Topics |
|---|---|---|
| Computer Fundamentals | `04_System_Design_Mastery/00_computer_fundamentals/` | CPU, memory, I/O, syscalls |
...
**Duration:** 4 weeks
**Repo:** `Python-DSA-API-Mastery/02_DSA_Mastery/`
...
```
02_DSA_Mastery/99_interview_master/dsa_0_2_years.md
02_DSA_Mastery/99_interview_master/dsa_3_5_years.md
02_DSA_Mastery/99_interview_master/dsa_faang_level.md
01_Python_Mastery/99_interview_master/scenario_based_questions.md
01_Python_Mastery/99_interview_master/tricky_edge_cases.md
04_System_Design_Mastery/99_interview_master/scenario_questions.md
04_System_Design_Mastery/99_interview_master/rapid_fire.md
03_API_Mastery/99_interview_master/scenario_based_questions.md
```
...
| 3 | **E-Commerce FastAPI** — OOP + JWT + SQLAlchemy + Docker + GitHub Actions CI/CD | After Phase 5 | `Python-DSA-API-Mastery/05_Capstone_Projects/14_Ecommerce_API_FastAPI/` |
...
```
# Coding Round
02_DSA_Mastery/99_interview_master/          ← based on company level

# Python Depth
01_Python_Mastery/99_interview_master/python_3_5_years.md
01_Python_Mastery/99_interview_master/tricky_edge_cases.md
...
# System Design
04_System_Design_Mastery/23_interview_framework/        ← use this framework every time
04_System_Design_Mastery/99_interview_master/
