...
|-------|------------------|
| Python functions + modules | `01_Python_Mastery/04_functions` |
| Pydantic | `01_Python_Mastery/14_type_hints_and_pydantic` |
| File handling | `01_Python_Mastery/08_file_handling` |
| Logging | `01_Python_Mastery/09_logging_debugging` |
| Testing with mocks | `01_Python_Mastery/17_testing` |
...
| Previous Project | [14 — E-Commerce API](../14_Ecommerce_API_FastAPI/README.md) |
