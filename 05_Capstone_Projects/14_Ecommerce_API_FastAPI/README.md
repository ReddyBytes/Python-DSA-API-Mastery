...
- `01_Python_Mastery/05_oops` — classes, inheritance, dunder methods
- `01_Python_Mastery/14_type_hints_and_pydantic` — Pydantic models and validators
- `03_API_Mastery/07_fastapi/first_api.md` — first endpoint, path/query params
- `03_API_Mastery/07_fastapi/database_guide.md` — SQLAlchemy with FastAPI
- `03_API_Mastery/05_authentication` — JWT concepts
- `01_Python_Mastery/17_testing` — pytest basics
...
| Next Project | [03 — Data Pipeline CLI](../03_Data_Pipeline_CLI/README.md) |
